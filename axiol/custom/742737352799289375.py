...
async def on_message(message):
    if message.channel.type == discord.ChannelType.text:
        server = client.get_guild("742737352799289375")   # Insert Discord server ID
        ...
        if mentions:
            ...
            if num_actions >= 2 and current_time - last_action[user_id]['time'][0] < time_interval:
                ...
                await member.add_roles(discord.utils.get(server.roles, id=742801455010021387)) # Insert Role ID (Muted Role)
