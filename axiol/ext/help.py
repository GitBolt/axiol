...
async def levelhelp(ctx: commands.Context):
    ...
    return discord.Embed(
        ...
        name=prefix + "leaderboard", value="Shows the server leaderboard",
        inline=False
    ).add_field(
        ...
        name=prefix + "givexp `<user>` `<amount>`", value="Gives user more XP",
        inline=False
    ).add_field(
...
async def welcomehelp(ctx: commands.Context):
    ...
    return discord.Embed(
        ...
        name=prefix + "wchannel `<#channel>`", value="Changes welcome channel",
        inline=False
    ).add_field(
        name=prefix + "wmessage",
        value="Changes welcome message",
        inline=False
    ).add_field(
        name=prefix + "wgreeting",
