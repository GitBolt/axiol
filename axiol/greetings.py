...
def greeting(member):
    greetinglist = [
        ...
        f'{member} Woooohooo! We are excited to have you here <a:hyper_cat:809781548210978828>',
        ...
        f'Roses are red, violets are blue, {member} hopped into the server, are they a kangaroo 🦘? ',
